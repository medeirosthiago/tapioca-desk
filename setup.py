...
setup(
    ...
    description='desk API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/medeirosthiago/tapioca-desk',
    packages=[
        'tapioca_desk',
    ],
    package_dir={'tapioca_desk': 'tapioca_desk'},
    include_package_data=True,
    install_requires=requirements,
    license="MIT",
    zip_safe=False,
    keywords='desk python tapioca wrapper',
    classifiers=[
